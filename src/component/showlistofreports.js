...
export default function List({data,key}){
     ...
     return(
        <>
        <HStack key={key}fontStyle={'italic'} ml='80px'w={'400'} p='30px'  backgroundColor='blue.400' flexWrap={'wrap'} textColor='white' borderRadius={'10px'} border='1px' borderRight={'none'}>
